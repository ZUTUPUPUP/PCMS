...
public class PieChart extends View {
    // 颜色表，ARGB
    private int[] mColors = {0xFF184D47, 0xFF96BB7C, 0xFF158467, 0xFFEEBB4D, 0xFFFECEAB, 0xFFFF8C69, 0xFFFF847C,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 将画布坐标原点移动到中心位置
        canvas.translate(100+mWidth / 2, mHeight / 2);
        // 饼状图半径
        ...
        canvas.translate(-80-mWidth/2, 100-mHeight/2);
        ...
        for (Pie pie : mData) {
            ...
            canvas.drawText(pie.getStr()+":" + df.format(pie.getPercentage() * 100 / 1) + "% "+ pie.getNum() +"人", 0, y, mPaint);
            System.out.println("");
            y += 36;
        }
    }
