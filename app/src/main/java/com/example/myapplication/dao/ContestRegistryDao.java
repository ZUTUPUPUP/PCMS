...
public class ContestRegistryDao {
    ...
    public ContestRegistryMessage findById(int id) {
        ...
        String sql = "select contestregistry.*, contest.contestName, user.userName, dep.name from contestregistry, contest, user, dep where contestregistry._id = " + id + " and contest.contestId and contestregistry.STNumberId = user._id and contestregistry.depId = dep._id;";
